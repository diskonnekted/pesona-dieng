...
<body class="font-inter bg-white text-gray-800 antialiased overflow-x-hidden">
    ...
    <section id="beranda" class="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div class="absolute inset-0">
            <img src="<?php echo e(asset('images/dieng_sunrise_hero.png')); ?>" alt="Dieng Sunrise" class="w-full h-full object-cover scale-105" id="hero-bg">
    ...
    <section id="destinasi" class="py-24 bg-dieng-mist/40 scroll-mt-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="group bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-2 fade-up">
                    <div class="relative overflow-hidden aspect-[4/3]">
                        <img src="<?php echo e(asset('images/candi_arjuna.png')); ?>" alt="Candi Arjuna" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110">
                        <div class="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent"></div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8" id="packages-grid">
                <?php $__currentLoopData = $packages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pkg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    ?>
                    <div class="package-card group bg-white rounded-2xl overflow-hidden shadow-lg border border-gray-100 hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 fade-up" data-category="<?php echo e($pkg['category']); ?>">
                        <div class="relative overflow-hidden aspect-[16/10]">
                            <img src="<?php echo e(asset($pkg['image'])); ?>" alt="<?php echo e($pkg['name']); ?>" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105">
                            <div class="absolute top-4 left-4 bg-dieng-gold text-white text-xs font-semibold px-3 py-1 rounded-full shadow-md">
                                ⏱️ <?php echo e($firstDuration['label']); ?>

                            </div>
                            <?php if($pkg['slug'] === 'dieng-sunrise-private' || $pkg['slug'] === 'open-trip-dieng-weekend'): ?>
                        ...
                        <div class="p-6 flex flex-col justify-between min-h-[360px]">
                            <div>
                                <div class="flex items-center gap-1 mb-3 text-sm">
                                    ...
                                    <span class="text-gray-500">(<?php echo e($pkg['reviews_count']); ?> ulasan)</span>
                                </div>
                                <h3 class="text-xl font-bold text-gray-900 group-hover:text-dieng-green transition-colors"><?php echo e($pkg['name']); ?></h3>
                                <p class="text-xs text-dieng-muted mt-2 line-clamp-2"><?php echo e($pkg['description']); ?></p>
                                
                                <!-- Highlight/Features list -->
                                <div class="grid grid-cols-2 gap-2 mt-4 py-4 border-y border-gray-100">
                                    <?php $__currentLoopData = array_slice($firstDuration['features'], 0, 4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <span class="flex items-center gap-2 text-xs text-gray-600 line-clamp-1">
                                            <i class="fa-solid fa-circle-check text-dieng-green text-[10px]"></i> <?php echo e($feat); ?>
                            ...
                            <div>
                                ...
                                <div class="mt-4 flex items-baseline justify-between">
                                    <div>
                                        <span class="text-xs text-gray-400 line-through block">Rp <?php echo e(number_format($firstDuration['original_price'], 0, ',', '.')); ?></span>
                                        <span class="text-2xl font-bold text-dieng-green">Rp <?php echo e(number_format($firstDuration['price'], 0, ',', '.')); ?></span>
                                        <span class="text-[10px] text-gray-500">/ <?php echo e($suffix); ?></span>
                                    </div>
                                    <span class="text-[10px] bg-red-100 text-red-700 px-2 py-0.5 rounded font-semibold uppercase"><?php echo e($firstDuration['discount']); ?></span>
                                </div>
                                
                                <a href="<?php echo e(route('paket.show', $pkg['slug'])); ?>" 
    ...
    <section id="galeri" class="py-24 bg-dieng-mist/40 scroll-mt-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4" id="gallery-grid">
                ...
                <!-- Pic 1 -->
                <div class="group relative overflow-hidden rounded-2xl aspect-square shadow-sm cursor-pointer fade-up" onclick="openLightbox('<?php echo e(asset('images/landscape_dieng.png')); ?>')">
                    <img src="<?php echo e(asset('images/landscape_dieng.png')); ?>" alt="Landscape Dieng" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110" loading="lazy">
                ...
                <!-- Pic 3 -->
                <div class="group relative overflow-hidden rounded-2xl aspect-square shadow-sm cursor-pointer fade-up" onclick="openLightbox('<?php echo e(asset('images/candi_arjuna.png')); ?>')">
                    <img src="<?php echo e(asset('images/candi_arjuna.png')); ?>" alt="Candi Arjuna" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110" loading="lazy">
                    <div class="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                        <i class="fa-solid fa-magnifying-glass-plus text-white text-3xl"></i>
                    </div>
                </div>
...
<?php /**PATH I:\wisatadieng\pesona-dieng-laravel\resources\views/welcome.blade.php ENDPATH**/ ?>